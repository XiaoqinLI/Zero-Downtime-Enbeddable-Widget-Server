...
(function (window, define, factory, undefined) {
    ...
    if (define !== undefined) {
        define(['./cs.queue.js', './cs.modernizr.js', './cs.spinner.js', './cs.helpers.js', './cs.base.js'], factory);
    } else {
        ...
        $.widget('crux.loadr', {
            ...
            _create: function () {
                ...
                if (this.options.filter !== null) {
                    ...
                    this.options.filter.on('keydown.loadr', _.debounce($.proxy(function (e) {
                    ...
                    .html('&times;')
                    .insertBefore(this.options.filter)
                    .on('click.' + this.widgetName, $.proxy(function (e) {
                        e.preventDefault();
