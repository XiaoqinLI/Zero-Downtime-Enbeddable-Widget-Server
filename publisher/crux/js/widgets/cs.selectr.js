/*! crux-selectr - v2.9.2 - 2015-01-29
...
(function (window, define, factory, undefined) {
  ...
  if (define !== undefined) {
      define(['./cs.modernizr.js', './cs.visibility.js', './cs.base.js', './cs.popover.js', './cs.ellipsr.js', './cs.loadr.js'], factory);
  } else {
  ...
  $.widget('crux.selectr', {
    ...
    _buildList: function () {
      ...
      if (this.options.filter) {
        ...
        html.clear = $('<a>', {
          'class': this._css.clear,
          href: '#'
        }).html('&times;').insertBefore(html.filter);
      }
    ...
    */
    clear: function (e) {
      ...
      if (this._vars.isBuilt && this.options.filter) {
        this._html.filter.focus()[0].value = '';
        this._filter(e);
      }
    },
